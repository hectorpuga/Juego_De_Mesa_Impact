 ...
 * @author HECTOR
 */
public class PanelJefeFinal  extends JLayeredPane {
   ...
   JProgressBar Maestro4B=new JProgressBar(0,57000);
   JTextArea Sucesos;
    ...
    PanelTablero Tablero=new PanelTablero();
      ...
      Random rndm = new Random();
        ...
        //VARIABLES GLOBALES
        double daño;
        int resultado = 0, numeroDeMaestro = 3;
 ...
 CajaSucesos();
    ...
    public void paintComponent(Graphics g)
    {
        ...
        ImageIcon Imagen=new ImageIcon(new ImageIcon(getClass().getResource("/Fondos/Jefe 4.jpg")).getImage());
    ...
    public void Batalla() {
 ImageIcon Imagen=new ImageIcon("J4.png");
        Batalla = new JLabel();
    ...
    public void creacionLabel(){
        ...
        maestros[3] = Maestro.Experto("Roberto", 57000, 2800, 2700, 1800, 40, 15, 2750);
      maestroActual = maestros[3];
        ...
        for (int i = 0; i < 7; i++) {
         ...
         for (int i = 0; i < 7; i++) {
            if(i==0){
           Lugar=1180;
            Dato=Integer.toString((int)maestros[3].getVida());
            }
            else if(i==1){
            
            Dato=Integer.toString((int)maestros[3].getDefensa());
            }
             else if(i==2){
            
            Dato=Integer.toString((int)maestros[3].getDañoBase());
            }
             else if(i==3){
            
            Dato=Integer.toString((int)maestros[3].getDañoCritico());
            }
             else if(i==4){
            
            Dato=Integer.toString((int)maestros[3].getProbabilidadCritico());
            Lugar=1190;
            }
             else if(i==5){
            Dato=Integer.toString((int)maestros[3].getProbabilidadEvadirAtaque());
            }
             else if(i==6){
            Lugar=1180;
            Dato=Integer.toString((int)maestros[3].getExperiencia());
            }
    ...
    public void desventajaCinco() {
     ...
     public void CreacionBarras(){
       ...
       add(Jugador4B,2,0);
        ...
        Maestro4B.setValue(57000);
        Maestro4B.setString("");
        Maestro4B.setBounds(762, 103, 164, 11);
        Maestro4B.setForeground(Color.red);
        Maestro4B.setBackground(Color.black);
        Maestro4B.setBorderPainted(false);
        add(Maestro4B,2,0);
    ...
    public JProgressBar getMaestro4B() {
        return Maestro4B;
    }

    public void setMaestro3B(JProgressBar Maestro4B) {
        this.Maestro4B = Maestro4B;
    }
