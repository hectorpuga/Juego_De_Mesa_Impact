 ...
 * @author HECTOR
 */
public class PanelJefe3 extends JLayeredPane {
   ...
   JProgressBar Maestro3B=new JProgressBar(0,57000);
   JTextArea Sucesos;
    ...
    PanelTablero Tablero=new PanelTablero();
      ...
      Random rndm = new Random();
        ...
        //VARIABLES GLOBALES
        double daño;
        int resultado = 0, numeroDeMaestro = 2;
 ...
 CajaSucesos();
    ...
    public void paintComponent(Graphics g)
    {
        ...
        ImageIcon Imagen=new ImageIcon(new ImageIcon(getClass().getResource("/Fondos/Jefe 3.jpg")).getImage());
    ...
    public void Batalla() {
 ImageIcon Imagen=new ImageIcon("J3.png");
        Batalla = new JLabel();
    ...
    public void creacionLabel(){
       ...
       maestros[2] = Maestro.Dificil("Almazán", 57000, 2600, 2700, 1800, 40, 15, 2750);
      maestroActual = maestros[numeroDeMaestro];
        ...
        for (int i = 0; i < 7; i++) {
         ...
         for (int i = 0; i < 7; i++) {
            if(i==0){
           Lugar=1180;
            Dato=Integer.toString((int)maestros[2].getVida());
            }
            else if(i==1){
            
            Dato=Integer.toString((int)maestros[2].getDefensa());
            }
             else if(i==2){
            
            Dato=Integer.toString((int)maestros[2].getDañoBase());
            }
             else if(i==3){
            
            Dato=Integer.toString((int)maestros[2].getDañoCritico());
            }
             else if(i==4){
            
            Dato=Integer.toString((int)maestros[2].getProbabilidadCritico());
            Lugar=1190;
            }
             else if(i==5){
            Dato=Integer.toString((int)maestros[2].getProbabilidadEvadirAtaque());
            }
             else if(i==6){
            Lugar=1180;
            Dato=Integer.toString((int)maestros[2].getExperiencia());
            }
   ...
   public  void desventajaUno() {
    ...
    public void desventajaCinco() {
     ...
     public void CreacionBarras(){
       ...
       add(Jugador4B,2,0);
        ...
        Maestro3B.setValue(57000);
        Maestro3B.setString("");
        Maestro3B.setBounds(762, 103, 164, 11);
        Maestro3B.setForeground(Color.red);
        Maestro3B.setBackground(Color.black);
        Maestro3B.setBorderPainted(false);
        add(Maestro3B,2,0);
    ...
    public JProgressBar getMaestro3B() {
        return Maestro3B;
    }

    public void setMaestro3B(JProgressBar Maestro2B) {
        this.Maestro3B = Maestro2B;
    }
