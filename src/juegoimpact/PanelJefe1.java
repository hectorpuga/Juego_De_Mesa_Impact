...
public class PanelJefe1 extends JLayeredPane {
   ...
   JTextArea Sucesos;
    ...
    PanelTablero Tablero=new PanelTablero();
      ...
      Random rndm = new Random();
        ...
        //VARIABLES GLOBALES
        double daño;
        int resultado = 0, numeroDeMaestro = 0;
 ...
 CajaSucesos();
    ...
    public void paintComponent(Graphics g)
    {
        ...
        ImageIcon Imagen=new ImageIcon(new ImageIcon(getClass().getResource("/Fondos/Jefe 1.jpg")).getImage());
 ...
 ImageIcon Imagen=new ImageIcon("J1.png");
    ...
    public void creacionLabel(){
      ...
      maestros[0] = Maestro.Facil("Pelayo", 57000, 2200, 2700, 1800, 40, 15, 2750);
