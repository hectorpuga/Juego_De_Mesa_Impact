 ...
 * @author HECTOR
 */
public class MiniBatalla extends JLayeredPane {
   ...
   JProgressBar Maestro1B=new JProgressBar(0,57000);
   JTextArea Sucesos;
    ...
    PanelTablero Tablero=new PanelTablero();
      ...
      Random rndm = new Random();
        ...
        //VARIABLES GLOBALES
        double daño;
        int resultado = 0, numeroDeMaestro = 5;
 ...
 CajaSucesos();
    ...
    public void paintComponent(Graphics g)
    {
        ...
        ImageIcon Imagen=new ImageIcon(new ImageIcon(getClass().getResource("/Fondos/Jefe Aleatorio.jpg")).getImage());
    ...
    public void Batalla() {
 ImageIcon Imagen=new ImageIcon("J1.png");
        Batalla = new JLabel();
    ...
    public void creacionLabel(){
      ...
      maestros[0] = Maestro.Facil("Anonimo", 57000, 2200, 2700, 1800, 40, 15, 2750);
      maestroActual = maestros[numeroDeMaestro];
        ...
        for (int i = 0; i < 7; i++) {
         ...
         for (int i = 0; i < 7; i++) {
            if(i==0){
           Lugar=1180;
            Dato=Integer.toString((int)maestros[0].getVida());
            }
            else if(i==1){
            
            Dato=Integer.toString((int)maestros[0].getDefensa());
            }
             else if(i==2){
            
            Dato=Integer.toString((int)maestros[0].getDañoBase());
            }
             else if(i==3){
            
            Dato=Integer.toString((int)maestros[0].getDañoCritico());
            }
             else if(i==4){
            
            Dato=Integer.toString((int)maestros[0].getProbabilidadCritico());
            Lugar=1190;
            }
             else if(i==5){
            
            Dato=Integer.toString((int)maestros[0].getProbabilidadEvadirAtaque());
            }
             else if(i==6){
            Lugar=1180;
            Dato=Integer.toString((int)maestros[0].getExperiencia());
            }
 ...
 public  void ventajaUno(int n) {
  ...
  Jugador1B.setValue(28000);
       ...
       add(Jugador4B,2,0);
        ...
        Maestro1B.setValue(57000);
        Maestro1B.setString("");
        Maestro1B.setBounds(762, 103, 164, 11);
        Maestro1B.setForeground(Color.red);
        Maestro1B.setBackground(Color.black);
        Maestro1B.setBorderPainted(false);
        add(Maestro1B,2,0);
    ...
    public JProgressBar getMaestro1B() {
        return Maestro1B;
    }

    public void setMaestro1B(JProgressBar Maestro1B) {
        this.Maestro1B = Maestro1B;
    }
